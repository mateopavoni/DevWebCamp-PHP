<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">DevWebCamp es una conferencia para desarolladores de todos los niveles, se lleva a cabo de forma presencial y en línea.</p>
        </div>
        <nav class="menu-redes"> 
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://github.com/mateopavoni">
                <span class="menu-redes__ocultar">GitHub</span>
            </a>
        </nav>
    </div>

    <p class="footer__copyright">DevWebCamp<span class="footer__copyright--regular"> - Todos los derechos reservados <?php echo date("Y")?> &copy;</span></p>
</footer>